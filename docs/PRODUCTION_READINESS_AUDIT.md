...
| **Assignments & Grading**             | ❌ NOT IMPLEMENTED (FRONTEND SOON) | _Nav sidebar only (No React routes)_                       | **Missing entities, repositories, and controller**                 |
| **Quizzes & Attempts**                | ❌ NOT IMPLEMENTED (FRONTEND SOON) | _Nav sidebar only (No React routes)_                       | **Missing entities, repositories, and controller**                 |
