  ...
  head: () => ({
    meta: [
      { title: "Platform Settings — Learntrix Admin" },
      {
        name: "description",
        content:
          "Configure organisation identity, contact details, branding, integrations and platform-wide defaults.",
      },
...
const toggles = [
  {
    ...
    hint: "Allow students to self-register from the website.",
    on: true,
  },
  {
    id: "autoEligibility",
    label: "Automatic career eligibility",
    hint: "Re-evaluate eligibility nightly using the active rule sets.",
    on: true,
  },
  {
    id: "attendanceAlerts",
    label: "Attendance alerts",
    hint: "Notify students and trainers when attendance drops below threshold.",
    on: true,
  },
  {
    id: "teacherArticles",
    label: "Teacher article submissions",
    hint: "Teachers can submit articles for admin review.",
    on: true,
  },
  {
    id: "maintenance",
    label: "Maintenance mode",
    hint: "Show a maintenance notice on the public website.",
    on: false,
  },
];
  ...
  return (
    <>
      <PageHeader
        ...
        description="Organisation-level configuration. Changes are recorded in the audit log."
      />
          ...
          >
            ...
            <div className="space-y-1.5 sm:col-span-2">
              ...
              <Textarea
                ...
                rows={2}
                maxLength={300}
                defaultValue="Enterprise learning and placement platform."
              />
            </div>
