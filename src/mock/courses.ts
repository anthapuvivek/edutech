...
export const mockCategories: Category[] = [
  {
    ...
    slug: "full-stack",
    courseCount: 24,
    description: "React, Node, APIs and modern web architecture.",
  },
  {
    id: "c2",
    name: "Data Science",
    slug: "data-science",
    courseCount: 18,
    description: "Statistics, analytics and production data workflows.",
  },
  {
    id: "c3",
    ...
    slug: "ai",
    courseCount: 15,
    description: "LLMs, RAG systems and applied deep learning.",
  },
  {
    id: "c4",
    ...
    courseCount: 16,
    description: "Model development from theory to deployment.",
  },
  {
    id: "c5",
    ...
    slug: "cloud",
    courseCount: 12,
    description: "Distributed systems and cloud-native design.",
  },
  {
    id: "c6",
    name: "AWS",
    slug: "aws",
    courseCount: 11,
    description: "Certification tracks and hands-on AWS engineering.",
  },
  {
    id: "c7",
    name: "DevOps",
    slug: "devops",
    courseCount: 10,
    description: "CI/CD, containers, observability and SRE practice.",
  },
  {
    id: "c8",
    name: "Cyber Security",
    slug: "cyber-security",
    courseCount: 9,
    description: "Offensive and defensive security fundamentals.",
  },
  {
    id: "c9",
    name: "Java",
    slug: "java",
    courseCount: 14,
    description: "Core Java, Spring Boot and enterprise backends.",
  },
  {
    id: "c10",
    name: "Python",
    slug: "python",
    courseCount: 21,
    description: "From language foundations to FastAPI services.",
  },
  {
    id: "c11",
    name: "Data Analytics",
    slug: "data-analytics",
    courseCount: 13,
    description: "SQL, BI tooling and decision analytics.",
  },
  {
    id: "c12",
    name: "Programming",
    slug: "programming",
    courseCount: 28,
    description: "Problem solving, DSA and engineering craft.",
  },
];
...
const seeds: Seed[] = [
  {
    ...
    subtitle: "React, TypeScript, FastAPI and PostgreSQL end to end",
    ...
    price: 24999,
    original: 44999,
    badges: ["Bestseller", "Career Track"],
  },
  {
    title: "Applied Machine Learning",
    subtitle: "From regression to production model serving",
    category: "Machine Learning",
    level: "Intermediate",
    skills: ["Python", "scikit-learn", "MLOps"],
    hours: 72,
    lessons: 168,
    rating: 4.8,
    ratings: 2190,
  ...
  },
  {
    ...
    subtitle: "RAG, embeddings, agents and evaluation",
    category: "Artificial Intelligence",
    level: "Advanced",
    skills: ["LLMs", "RAG", "Vector Search"],
    hours: 58,
    lessons: 132,
    rating: 4.9,
    ratings: 1480,
  ...
  },
  {
    ...
    subtitle: "Design resilient cloud architectures with confidence",
    category: "AWS",
    level: "Intermediate",
    skills: ["AWS", "IAM", "VPC", "S3"],
    hours: 64,
    lessons: 158,
    rating: 4.8,
    ratings: 3050,
  ...
  },
  {
    ...
    subtitle: "Statistics, SQL, Python and storytelling with data",
  ...
  },
  {
    ...
    subtitle: "Docker, Kubernetes, Terraform and CI/CD pipelines",
    category: "DevOps",
    level: "Advanced",
  ...
  },
  {
    ...
    subtitle: "Threat modelling, network defence and secure coding",
    category: "Cyber Security",
    level: "Beginner",
    skills: ["Security", "Networking", "OWASP"],
    hours: 46,
    lessons: 112,
    rating: 4.6,
    ratings: 940,
  ...
  },
  {
    ...
    subtitle: "Enterprise-grade services, testing and deployment",
    category: "Java",
    level: "Intermediate",
  ...
  },
  {
    ...
    subtitle: "Language mastery, tooling and clean architecture",
    category: "Python",
    level: "Beginner",
  ...
  },
  {
    ...
    subtitle: "Interview-grade problem solving with 500+ problems",
  ...
  },
  {
    ...
    subtitle: "Event-driven design, service meshes and scaling",
    category: "Cloud Computing",
    level: "Advanced",
    skills: ["Microservices", "Kafka", "gRPC"],
    hours: 54,
    lessons: 126,
    rating: 4.7,
    ratings: 810,
  ...
  },
  {
    ...
    subtitle: "SQL, dashboards and decision-ready insight",
...
export const mockTestimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    quote:
      "The Full Stack track was the most structured program I have taken. The project reviews were as rigorous as a real code review at work.",
  },
  {
    id: "t2",
    name: "Arjun Nair",
    ...
    rating: 5,
    quote:
      "Learntrix combined theory with real datasets. I moved from support engineering into a data science role in nine months.",
  },
  {
    id: "t3",
    name: "Fatima Khan",
    ...
    rating: 5,
    quote:
      "The AWS labs and the coding practice platform together made certification feel like a by-product rather than the goal.",
  },
  {
    id: "t4",
    name: "Rohit Deshmukh",
    ...
    rating: 5,
    quote:
      "500+ curated problems with the AI coding coach explaining my failed submissions is what finally got me through interviews.",
  },
];
